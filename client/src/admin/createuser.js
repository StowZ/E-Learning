                    ...
                    <div className="row">
                        <div className="col-md-6 mt-5 mx-auto">
                            <form onSubmit={this.onSubmit} >
                                ...
                                <br />
                                <br />
                                <h1 className="h3 mb-3 font-weight-bold" style={{ textDecoration: "underline", color: "#1A78B8" }}>Create New User</h1>
                                ...
                                <input style={{ backgroundColor: "#1A78B8" }} type="submit" value="Add User" className="btn btn-lg btn-info btn-info btn-block" />
                            </form>
                        </div>
                    </div>
                </div>
